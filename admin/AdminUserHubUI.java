//central hub for adding or editing user accounts
//routes admin to specific registration forms
package admin;
import common.*;
import javax.swing.*;
import java.awt.*;
...
public class AdminUserHubUI extends JFrame {
    ...
    public AdminUserHubUI() {
        ...
        b1.addActionListener(e -> new AdminAddStudentUI()); // RENAMED
        b2.addActionListener(e -> new AdminEditStudentUI().setVisible(true)); // RENAMED
        b3.addActionListener(e -> new AdminAddCompanyUI().setVisible(true)); // RENAMED
        b4.addActionListener(e -> new AdminEditCompanyUI().setVisible(true)); // RENAMED
        b5.addActionListener(e -> new AdminAddAcademicUI()); // RENAMED
        b6.addActionListener(e -> new AdminEditAcademicUI().setVisible(true)); // RENAMED
