//interface to link placed students with academic supervisors
//displays matches missing a supervisor
package admin;
import common.*;
import javax.swing.*;
...
public class AdminMatchingUI extends JFrame {
    ...
    private void loadData() {
        ...
        for(String[] m : DatabaseHelper.getMatchesMissingSupervisor()) placedModel.addRow(new Object[]{m[0], m[2], m[4]}); // UPDATED
        for(String[] u : DatabaseHelper.getUsersByRole("Academic Supervisor", "")) svModel.addRow(new Object[]{u[0], u[2]}); // UPDATED
    }
    ...
    private void assign() {
        ...
        DatabaseHelper.assignAcademicSupervisor(mid, aid); // UPDATED
