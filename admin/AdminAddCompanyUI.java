//form interface to register a new company supervisor
//links supervisor to a specific company
package admin;
import common.*;
import javax.swing.*;
...
public class AdminAddCompanyUI extends JFrame {
    ...
    private void register() {
        ...
        DatabaseHelper.saveCompanySupervisor(user, pass, name, pos, comp, email); // UPDATED
