//interface to search and modify student details
...
public class AdminEditStudentUI extends JFrame {
    ...
    private void loadStudents(String query) {
        ...
        List<String[]> users = DatabaseHelper.getUsersByRole("Student", query); // UPDATED
    ...
    private void updateStudent() {
        ...
        DatabaseHelper.updateStudent(currentId, userField.getText(), passField.getText(), nameField.getText(), matricField.getText()); // UPDATED
