...
## Known Bugs
* Sometimes the scroll speed is a bit slow (I tried to fix it in the code though).
* If you delete a user manually from the text file, things might break. Just use the Admin panel.
