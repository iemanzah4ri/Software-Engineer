//form for company supervisor to grade interns
//saves performance score and feedback
package company;
import common.*;
import javax.swing.*;
...
public class CompanyEvaluationUI extends JFrame {
    ...
    private void submit() {
        ...
        String[] sv = DatabaseHelper.getUserById(supervisorId); // UPDATED
        String cname = (sv!=null && sv.length>8) ? sv[8] : "Unknown";
        
        DatabaseHelper.saveCompanyFeedback( // UPDATED
